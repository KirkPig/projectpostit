...
public class RBSelection extends VBox{
	public RBSelection() {
		...
		newButton.setOnMouseClicked((MouseEvent e) -> {
			...
			this.getChildren().add(new BillingNewUI());
	...
	// =============================================================================
		...
		TableColumn datedue = new TableColumn("date due");
		...
		table.getColumns().addAll(code,date,datedue,customerName,creator);
		...
		table2.getColumns().addAll(code,date,datedue,descriptionCol,creator);
